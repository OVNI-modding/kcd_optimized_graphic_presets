...
function ogp.AddConsoleCommands()
	...
	System.AddCCommand( 'ogp_run_tests', 'ogp.RunTests(%1)', "ogp_run_tests( verbose[0/1] ) runs unit tests" )
	...
	System.AddCCommand( 'ogp_set_3pl', 'ogp.SetCVar("sys_spec_ogp_3pl", %1)', ogp_set_xxx_doc )
